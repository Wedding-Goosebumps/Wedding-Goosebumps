  ...
  <section className="bg-[#FFFF] text-charcoal py-24">
      <div className="container mx-auto px-6 max-w-[1100px]">
        ...
        <div className="text-center mb-20 md:mb-24">
          ...
          <p className="font-lora text-[17px] max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-x-16 xl:gap-x-24 items-start mb-8">
          ...
          <div className="lg:col-span-6 flex flex-col items-start mt-22 justify-center">
            ...
            <h3 className="font-playfair-display text-[26px] md:text-[28px] leading-snug mb-4">
              Why we do what we do.
            </h3>

            <div className="w-12 h-[1px] bg-charcoal/20 mb-15" />

            <p className="font-lora text-[16px] leading-relaxed text-charcoal/90 mb-6">
              We aren’t driven by checklists.
            </p>

            <p className="font-lora text-[16px] leading-relaxed text-charcoal/85 mb-6">
            ...
            <p className="font-lora text-[16px] leading-relaxed text-charcoal/85">
