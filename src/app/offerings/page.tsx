  ...
  const OFFERINGS_DATA = [
    {
      ...
      image: "/offerings-page/slider/1.jpg",
    },
    {
      ...
      image: "/offerings-page/slider/2.jpg",
    },
    {
      title: "DESIGN & DECOR",
      description: [
      ...
      image: "/offerings-page/slider/3.jpg",
    },
    {
    ...
    <main className="bg-ivory text-charcoal">
      ...
      <section className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[100vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          <div className="text-center max-w-4xl">
            <h1 className="font-epicene-display text-white/95 uppercase leading-tight text-[24px] sm:text-[32px] md:text-[42px] lg:text-[52px] drop-shadow">
              FULL SERVICE<br />
              LUXURY WEDDING DESIGN AND PLANNING
            </h1>
            <p className="mt-3 sm:mt-4 font-lora tracking-[0.15em] sm:tracking-[0.20em] text-white/90 uppercase text-[10px] sm:text-xs">
      ...
      <section className="bg-ivory py-12 sm:py-16 lg:py-24">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
          <div className="grid grid-cols-1 items-center gap-8 sm:gap-10 lg:gap-10 lg:grid-cols-2">
            {/* LEFT: copy */}
            <div className="order-2 lg:order-1">
              {/* Headline */}
              <h2 className="font-epicene-display uppercase leading-[1.08] text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] tracking-[0.01em] text-charcoal">
              ...
              <p className="mt-3 sm:mt-4 text-[10px] sm:text-[11px] md:text-[12px] tracking-[0.25em] sm:tracking-[0.3em] uppercase text-charcoal/70 leading-[1.6]">
              ...
              {/* thin rule */}
              <div className="mt-4 sm:mt-6 h-[2px] w-12 sm:w-16 bg-charcoal/15" />

              {/* Body copy */}
              <p className="mt-6 sm:mt-8 font-lora text-[15px] sm:text-[16px] md:text-[16.5px] leading-[1.8] sm:leading-[1.95] text-charcoal/90 max-w-[56ch] pb-2">
              ...
              <Link href="/inquire" className="inline-block mt-2">
                <span className="font-commuter-sans text-[11px] sm:text-[12px] uppercase tracking-[0.25em] sm:tracking-[0.3em] text-gold border-b-[1.5px] border-gold pb-1">
                  WORK WITH US
                </span>
              </Link>
            </div>
            ...
            {/* RIGHT: image */}
            <div className="relative bg-[#efe9df] h-[50vh] sm:h-[60vh] md:h-[80vh] lg:h-[100vh] order-1 lg:order-2">
              <Image
      ...
      <section className="py-16 sm:py-20 md:py-24">
        ...
        <div
          className="
            ...
            h-[400px] sm:h-[500px] md:h-[600px] lg:h-[680px] xl:h-[700px]
          "
              ...
              return (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-colors ${
                    active ? 'bg-charcoal' : 'bg-charcoal/30'
                  }`}
                />
              );
            })}
        ...
        {/* Text content */}
        <div className="mx-auto w-full max-w-[1050px] px-4 sm:px-6 text-center">
          {/* small overline */}
          <p className="uppercase tracking-[0.3em] sm:tracking-[0.35em] text-[10px] sm:text-[11px] text-charcoal/60 mb-3 sm:mb-4">
            Our approach
          </p>

          {/* big headline */}
          <h2 className="font-epicene-display uppercase leading-[1.08] text-[28px] sm:text-[34px] md:text-[42px] lg:text-[48px] xl:text-[56px] text-charcoal">
            to flawless wedding celebrations
          </h2>

          {/* italic sub-headline */}
          <p className="mt-3 sm:mt-4 font-cormorant italic text-[16px] sm:text-[18px] md:text-[20px] text-charcoal/85 max-w-3xl mx-auto">
          ...
          <div className="mt-6 sm:mt-8 flex items-center justify-center gap-4">
            <span className="block h-[1px] w-20 sm:w-32 md:w-40 bg-charcoal/15" />
            <span className="block h-[1px] w-20 sm:w-32 md:w-40 bg-charcoal/15" />
          </div>

          {/* body paragraph */}
          <p className="mt-6 sm:mt-8 font-lora text-[15px] sm:text-[16px] md:text-[16.5px] leading-[1.8] sm:leading-[1.95] text-charcoal/90 max-w-[920px] mx-auto">
          ...
          <div className="mt-8 sm:mt-10">
            <Link
              href="/inquire"
              className="inline-flex items-center justify-center px-8 sm:px-10 py-3 sm:py-4 bg-[#C2A770] hover:bg-[#B79A63] transition-colors text-white tracking-[0.18em] sm:tracking-[0.2em] uppercase text-xs font-lora"
            >
              Work with us
            </Link>
          </div>
      ...
      <section className="bg-ivory py-16 sm:py-20 md:py-28">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
          ...
          <div className="max-w-3xl mb-10 sm:mb-12 md:mb-16">
            <p className="uppercase tracking-[0.25em] sm:tracking-[0.3em] text-[10px] sm:text-[11px] text-charcoal/60 mb-3 sm:mb-4">
              OUR OFFERINGS
            </p>
            <h2 className="font-epicene-display uppercase leading-[1.08] text-[28px] sm:text-[34px] md:text-[42px] lg:text-[48px] xl:text-[56px] text-charcoal">
              FULL SERVICE WEDDING PLANNING <span className="italic normal-case font-epicene-display lowercase">and</span> DESIGN
            </h2>
            <p className="mt-4 sm:mt-6 font-lora text-[15px] sm:text-[16px] md:text-[16.5px] leading-[1.8] sm:leading-[1.95] text-charcoal/90 max-w-[75ch]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-20 items-start">
            ...
            <div className="flex flex-col h-full order-2 lg:order-1">
              <div className="flex-grow">
                {/* Number Indicator */}
                <div className="flex items-center gap-3 sm:gap-4 border-b border-charcoal/15 pb-3 sm:pb-4">
                  <span className="font-light text-xl sm:text-2xl text-charcoal/80 tabular-nums">
                ...
                {/* Title */}
                <h3 className="font-epicene-display uppercase text-[20px] sm:text-[24px] md:text-[28px] leading-tight mt-4 sm:mt-6 text-charcoal">
                  {OFFERINGS_DATA[currentOffering].title}
                </h3>
                
                {/* Description */}
                <div className="mt-3 sm:mt-4 font-lora text-[15px] sm:text-[16px] leading-[1.8] sm:leading-[1.9] text-charcoal/80 max-w-[55ch] space-y-4">
              ...
              <div className="mt-8 sm:mt-10 flex items-center justify-between">
                <button
                  ...
                  className="text-[11px] sm:text-[12px] tracking-[0.18em] sm:tracking-[0.2em] uppercase text-charcoal/80 hover:text-gold transition-colors group flex items-center gap-2"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-3 h-3 sm:w-4 sm:h-4 transition-transform group-hover:-translate-x-1">
            ...
            {/* RIGHT: Image */}
            <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] bg-[#efe9df] order-1 lg:order-2">
               <Image
                  key={currentOffering}
      ...
      <section className="bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="lg:sticky lg:top-0 h-[50vh] sm:h-[60vh] md:h-[80vh] lg:h-screen">
          ...
          <div className="px-4 sm:px-6 md:px-10 lg:px-16 py-12 sm:py-16 lg:py-24">
            
            {/* Top Thumbnails: Horizontally scrolling */}
            <div className="overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden mb-8 sm:mb-10 md:mb-12">
              <div className="grid grid-flow-col auto-cols-[60%] sm:auto-cols-[45%] md:auto-cols-[30%] lg:auto-cols-[22%] gap-3 sm:gap-4">
                {[
            ...
            {/* Heading */}
            <h2 className="font-epicene-display uppercase leading-tight text-[28px] sm:text-[32px] md:text-[36px] lg:text-4xl xl:text-5xl text-charcoal pt-1 sm:pt-3">
              Our Process
            </h2>

            {/* Steps List */}
            <ol className="mt-6 sm:mt-8 divide-y divide-charcoal/10 border-y border-charcoal/10">
              {[
                "Reach out to Us",
                "Schedule a meeting",
                ...
                <li key={i} className="grid grid-cols-[auto_1fr] items-baseline gap-4 sm:gap-6 py-4 sm:py-5">
                  <span className="font-sans text-[10px] sm:text-xs uppercase tracking-[0.35em] sm:tracking-[0.4em] text-[#b6a78f] tabular-nums">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <span className="font-lora text-[15px] sm:text-base md:text-lg leading-relaxed text-charcoal/90">
                    {step}
                  </span>
                </li>
              ))}
      ...
      <section className="py-16 sm:py-20 md:py-28 bg-ivory">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Top row: two images */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="relative h-[400px] sm:h-[500px] md:h-[560px] lg:h-[700px] xl:h-[830px] bg-[#efe9df]">
              <Image
          ...
          <div className="mt-10 sm:mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 items-start">
            {/* LEFT — stacked headline */}
            <div className="text-left">
              <h2
                className="
                  font-epicene-display uppercase
                  text-[28px] sm:text-[34px] md:text-[42px] lg:text-[48px] xl:text-[52px]
              ...
              <div className="mt-3 sm:mt-4 h-px w-full max-w-[340px] bg-neutral-300/60" />
            </div>

            {/* RIGHT — body copy + cta */}
            <div className="max-w-[560px]">
              <p className="text-[16px] sm:text-[17px] md:text-[18px] leading-[1.9] sm:leading-[2.0] text-neutral-800 font-lora">
      ...
      <section className="relative w-full h-[60vh] sm:h-[80vh] lg:h-[100vh] overflow-hidden">
...
function ServiceBlock({
  ...
  return (
<div className={`container grid grid-cols-1 gap-10 lg:grid-cols-2 items-center ${reverse ? "lg:grid-flow-dense" : ""}`}>
      {/* image */}
